...
public:
    ...
    PeriodicCFIterator(const PeriodicCF &cf) : cf{cf}, it{0} {}
...
protected:
    ...
    Iterator *getIterator() const ;
public:
    MagicBoxCF(const ContinuedFraction &f, cf_int a, cf_int b) : boxedFraction{f}, a{a}, b{b} {}
    ~MagicBoxCF() {}
};
...
public:
    MagicBoxCFIterator(Iterator *cf, cf_int a, cf_int b) : boxedIterator{cf}, i{a}, j{b}, k{1}, l{0} { updateIndeces(); }
